...
class User extends DataClass implements Insertable<User> {
  ...
  final String name;
  final int? category;
  User({required this.id, required this.name, this.category});
  ...
  User copyWith({int? id, String? name, int? category}) => User(
        id: id ?? this.id,
        name: name ?? this.name,
...
class UsersCompanion extends UpdateCompanion<User> {
  ...
  UsersCompanion copyWith(
      {Value<int>? id, Value<String>? name, Value<int?>? category}) {
    return UsersCompanion(
      id: id ?? this.id,
      name: name ?? this.name,
      category: category ?? this.category,
